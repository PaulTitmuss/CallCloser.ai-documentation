...
After an inbound call, CallCloser.ai provides transcripts, analytics, and possible automation triggers.
...
- In your CallCloser.ai dashboard, go to **Calls** or **History**.
