---
title: "CallCloser Tool"
icon: "phone"
description: "Learn how to use CallCloser triggers and actions in your AI calling flows"
---

# CallCloser Tool

The CallCloser tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalised conversations and automated follow-ups.

<Note>
  You can find the CallCloser tool prominently displayed at the top of the
...
![CallCloser Call Ended Trigger](/resources/autocalls-trigger.jpg)
...
![CallCloser Action](/resources/autocalls-action.jpg)
