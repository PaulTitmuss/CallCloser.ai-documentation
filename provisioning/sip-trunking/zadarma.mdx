...
4. Click on external services and then check the option for SIP URI.
  ...
  Add ```sip:extension@5wed79aeavr.sip.livekit.cloud ``` (this is CallCloser SIP server address) .
...
## Step 2: Import numbers to CallCloser

You need to import to CallCloser.
...
3. Click “Integrate SIP trunk”
   ...
   <Frame>
     <img
       ...
       alt="Import numbers to CallCloser"
     />
   </Frame>
...
{/* - If you opted for auth route select Username and password.
   ...
   <Frame>
     <img
       ...
       alt="Twillio CallCloser Credentials Auth Type"
     />
   </Frame> */}
...
- Add the **IPs** from **Zadarma** (Step 1).
   ...
   <Frame>
     <img
       ...
       alt="Twillio CallCloser Credentials IP Type"
     />
   </Frame> 
...
7. Select the country of where your SIP trunk is located. 
    ...
    <Frame>
      <img
        ...
        alt="Twillio CallCloser SIP Country"
      />
    </Frame>
