...
description: "Learn how to use your existing phone numbers or Twilio account with CallCloser.ai through SIP integration or Caller ID verification"
---
...
- Inbound & outbound will flow through your existing lines, but still utilize CallCloser.ai's AI.
...
- Meanwhile, you can have the best of both worlds by provisioning Twilio-based numbers through CallCloser.ai or using a custom approach.
